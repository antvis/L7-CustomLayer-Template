...
var CustomModel = /*#__PURE__*/ (function (_BaseModel) {
  _inherits(CustomModel, _BaseModel);

  var _super = _createSuper(CustomModel);

  function CustomModel() {
    _classCallCheck(this, CustomModel);

    return _super.apply(this, arguments);
  }

  _createClass(CustomModel, [
    {
      key: 'getUninforms',
